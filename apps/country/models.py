...
# From http://www.djangosnippets.org/snippets/1476/
COUNTRIES = (
    ('AR', _('Argentina')),
    ('AF', _('Afghanistan')),
    ('AX', _('Aland Islands')),
    ...
    ('EE', _('Estonia')),
    ('ET', _('Ethiopia')),
    ('FK', _('Islas Malvinas (Falkland Islands)')),
    ('FO', _('Faroe Islands')),
    ('FJ', _('Fiji')),
    ('FI', _('Finland')),
    ('FR', _('France')),
...
COUNTRIES_CODE = [x[0] for x in COUNTRIES]

class Error(Exception):
    pass

class Country(db.Model):
    code = db.StringProperty(choices=COUNTRIES_CODE)
    ...
    def name(self):
        """
            Return country name
        """
        return dict(COUNTRIES)[self.code]
